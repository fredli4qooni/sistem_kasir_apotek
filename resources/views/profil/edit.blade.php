            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profil.update') }}">
                        ...
                        <hr>
                        <p class="text-muted text-center">Kosongkan field password jika tidak ingin mengubah password.</p>

                        {{-- Password Lama (Opsional, untuk keamanan tambahan jika mengubah password) --}}
                        {{-- Kita akan buat ini wajib jika password baru diisi --}}
                        <div class="row mb-3">
                            <label for="current_password" class="col-md-4 col-form-label text-md-end">{{ __('Password Lama') }}</label>
                            <div class="col-md-6">
